...
function _renderPanel(panel) {
    ...
    // 2026-06-23 v6.4: PETL section 已移除 (character_book 单向破坏 + 击穿 prefix cache)
    //   worldbook 位置管理推荐用 WM (jerryzmtz/worldbook-manager)
    //   CFS 启动期会静默清掉历史 [CFS4_AUTO] 标签 (独立 worldbook only, 不动 character_book)
    //   已被 PETL v6.3 破坏过 character_book 的角色卡需要删卡重导, 抱歉. 卡可以重导, 聊天存档不丢.
    ...
    // 2026-06-23 v6.4: PETL events 已移除 (PETL 模块整体砍掉)
